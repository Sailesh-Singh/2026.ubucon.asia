...
<div style="display: flex; gap: 10px;">
  ...
  <a href="/ubucon-asia-2026-sponsorship-prospectus-local.pdf">
...
| Price(TWD)<sup>*0</sup> | 300,000  | 180,000 | 105,000 | 48,000 | 15,000 - 24,000 <small>(Startups: 6,000 - 24,000<sup>*7</sup>)</small> |
| **Logo exposures** || |
| Website | XL | L | M | S | S |
...
| Sponsor booth | L | M | S<sup>*5</sup> | S<sup>*5</sup> (500 USD or 15,000 TWD<sup>*0</sup> Add-on FCFS) | No |
...
Exhibitor package | **600 USD (or 18,000 TWD for Local sponsors)**
...
Diversity funds package | **200 - 700 USD (or 6,000 - 21,000 TWD for Local sponsors)**
...
### Notes
- *0: Price in New Taiwan Dollar (TWD) is only eligible for business with primary office in Taiwan.
